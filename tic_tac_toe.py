# Первый проект курса: Игра в Крестики-Нолики для двоих игроков, которую я немного модернизировал.
# 1. Игра была русифицирована;
# 2. Добавлена возможность играть при русской раскладке клавиатуры;
# 3. Игроки персонализированы. Можно вписать своё имя и при каждом диалоге компьютер будет обращаться к игрокам по имени.
